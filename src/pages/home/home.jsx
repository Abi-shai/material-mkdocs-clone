...
const Home = () => {
  ...
  useLayoutEffect(() => {
    ...
    let ctx = gsap.context(() => {
      ...
      gsap.to(".transition__2", {
        scrollTrigger: '.transition__2',
        opacity: 1,
        duration: .5,
        ease: "power2.out",
        delay: .2
      ...
      gsap.to(".transition__1", {
        scrollTrigger: '.transition__1',
        opacity: 1,
        duration: .5,
        ease: "power2.out",
        delay: .2
  ...
  return (
    ...
    >
      ...
      <div className="pre-content">
        ...
        <ul ref={topAnim} className="mdx-expect__list">
          <li className="mdx-expect__item transition__2 md-typeset">
          ...
          <li className="mdx-expect__item transition__1  md-typeset">
            <div className="mdx-expect__item-2">
              <div className="mdx-expect__icon">
      ...
      <section className="sponsor-wrapper">
        <div className="sponsor-wrapper-3 sponsor-wrapper-2">
          ...
          <div className="trusted-wrapper-3 right">
